...
public class Chess {
	...
	public static void main(String[] args) {
		if (args[1].equals("2")){
			placeOnBoard(new Rook(), Integer.parseInt(args[3]));
			placeOnBoard(new Bishop(), Integer.parseInt(args[3]));
			placeOnBoard(new Queen(), Integer.parseInt(args[3]));
			placeOnBoard(new Knight(), Integer.parseInt(args[3]));
		}
		else if (args[1].equals("3")){
			Chess3D.startGame(args);
		}
	}
	 ...
	 * placed.
	 */
	public static void placeOnBoard(Rook chessPiece, int size) {
		ChessBoard gameBoard = new ChessBoard(size);
	 ...
	 * placed.
	 */
	public static void placeOnBoard(Bishop chessPiece, int size) {
		ChessBoard gameBoard = new ChessBoard(size);
		chessPiece.moveOnBoard(gameBoard);
	}
	 ...
	 * placed.
	 */
	public static void placeOnBoard(Queen chessPiece, int size) {
		ChessBoard gameBoard = new ChessBoard(size);
		chessPiece.moveOnBoard(gameBoard);
	}
	 ...
	 * placed.
	 */
	public static void placeOnBoard(Knight chessPiece, int size) {
		ChessBoard gameBoard = new ChessBoard(size);
		chessPiece.moveOnBoard(gameBoard);
	}
